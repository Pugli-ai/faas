...
# We simply want this to fail if the SECRET_KEY is not set
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "faas-442515.ew.r.appspot.com",
    "https://ideapools.livelygrass-ca7503d5.francecentral.azurecontainerapps.io",
...
if os.getenv("GAE_APPLICATION", None):
    ...
    DATABASES = {
        "default": {
            ...
            "HOST": os.getenv(
                "DB_HOST", "localhost"
            ),  # Using the IP address from the Cloud SQL instance
